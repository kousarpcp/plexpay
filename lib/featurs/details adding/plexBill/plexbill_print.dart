...
class plexbillPrint extends StatefulWidget {
  // final id;

  const plexbillPrint({super.key});

  @override
  State<plexbillPrint> createState() => _plexbillPrintState();
}

class _plexbillPrintState extends State<plexbillPrint> {
                        ...
                        children: [
                          ...
                          Container(
                              ...
                              child: Wrap(
                                ...
                                children: [
                                  Details("Customer ID", "6"),
                                  Details("TRN Number", "6456"),
                                  Details("Invoice Date","${DateTime.now().day}-${DateTime.now().month}-${DateTime.now().year}"),
                                  Details("Payment Type", "CASH"),
