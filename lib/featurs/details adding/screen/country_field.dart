...
@override
  ...
  Widget build(BuildContext context) {
    ...
    return MediaQuery.of(context).size.width > 650?DefaultTabController(
      length: 3,
      child: Scaffold(
                ...
                child: widget.code!=null?Container(
                  ...
                  child: IntlPhoneField(
                    ...
                    decoration: InputDecoration(
                      // labelText: "Number",
                      // label: Text(""),
                      contentPadding: EdgeInsets.only(bottom: height*0.03),
                  ...
                  child: TextFormField(
                    ...
                    style: TextStyle(
                        fontSize: width * 0.019, fontWeight: FontWeight.w600),
                    decoration: InputDecoration(
                      // labelText: "Number",
                      // label: Text(""),
                      labelStyle: TextStyle(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Container(child: Center(child: Text("+"+selectedCountry,style: TextStyle(fontSize: width*0.019,color: colorConst.blue),))),
                            ],
                          ),
                      ...
                      prefix: InkWell(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              Icon(Icons.arrow_drop_down_sharp),
                              Container(child: Center(child: Text("+"+selectedCountry,style: TextStyle(fontSize: 18,color: colorConst.blue),))),
                            ],
                          ),
