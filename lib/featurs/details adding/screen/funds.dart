...
class _TransState extends State<Funds> {
  ...
  Future<String> getHome() async {
    ...
    if(rsp['status']==true && rsp['result']!="Empty"){
      ...
      setState(() {
        ...
        arrProdList = rsp['result']['all_data'];
